...
import com.neu.shopping.authentication.MyDBAuthenticationService;
...
protected void configure(HttpSecurity http) throws Exception {
    ...
    // For Admin/Vendors only.
    http.authorizeRequests().antMatchers("/product").access("hasRole('ROLE_MANAGER')");

    // When the user has logged in as another role.
    // But access a page with different role,
