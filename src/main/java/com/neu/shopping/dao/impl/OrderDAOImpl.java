...
import com.neu.shopping.entity.Order;
import com.neu.shopping.entity.OrderDetail;
import com.neu.shopping.entity.Product;
import com.neu.shopping.model.CartInfo;
import com.neu.shopping.model.CartLineInfo;
...
public class OrderDAOImpl implements OrderDAO {
  ...
  public void saveOrder(CartInfo cartInfo) {
      ...
      order.setUsernName(userDetails.getUsername());
  ...
  public PaginationResult<OrderInfo> listOrderInfo(int page, int maxResult, int maxNavigationPage) {
	  ...
	  boolean isUser = false;
	    for (GrantedAuthority grantedAuthority : authorities){
	        if (grantedAuthority.getAuthority().equals("ROLE_MANAGER")) {
	        	isAdmin = true;
	            break;
	        }else if (grantedAuthority.getAuthority().equals("ROLE_EMPLOYEE") || grantedAuthority.getAuthority().equals("ROLE_USER")) {
	        	isUser = true;
	            break;
	        }
	    }
      ...
      Query query = session.createQuery(sql);
      if(isUser) {
      query.setParameter("uName", userDetails.getUsername());
      }
