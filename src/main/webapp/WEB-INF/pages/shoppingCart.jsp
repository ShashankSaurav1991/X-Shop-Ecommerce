...
<body>
	...
	<c:if test="${not empty cartForm and not empty cartForm.cartLines   }">
		<form:form method="POST" modelAttribute="cartForm"
			...
			<a class="navi-item"
				href="${pageContext.request.contextPath}/shoppingCartCustomer">Proceed For Shipping Details</a>
			<a class="navi-item"
				href="${pageContext.request.contextPath}/productList">Continue Shopping?</a>
		</form:form>
	</c:if>
